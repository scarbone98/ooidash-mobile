...
class Moon extends AnimatedObject {
  ...
  Moon(BoxGame game, double x, double y)
      : super(game, x, GlobalVars.offScreenTargetTop) {
    objectRect = Rect.fromLTWH(x, y + GlobalVars.offScreenTargetBottom,
        game.tileSize * size, game.tileSize * size);
